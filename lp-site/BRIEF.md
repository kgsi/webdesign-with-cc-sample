# AURORA AIRWAYS ランディングページ制作ブリーフ

## 目的

架空の航空会社「AURORA AIRWAYS」のランディングページを制作する。ブランドの世界観を伝えつつ、航空券検索と予約への導線を提供する。
...
- デザインの方向性は `moodboard/aurora-airways-moodboard.jpg` を参照
...
1. ヘッダー：ロゴ、ナビゲーション（旅先を探す／ご旅行の計画／ご搭乗サポート／Aurora Club）、ログイン
...
6. 特別なオファー：ヨーロッパ行き特別運賃 最大20%OFF／早期予約割引 南の楽園へ 最大15%OFF／Aurora Club会員限定 ボーナスマイルキャンペーン
...
- `moodboard/aurora-airways-moodboard.jpg`：ムードボード
